...
> 
> 
> **Y.3. Cap on Damages:** To the maximum extent permitted by law, the Provider’s aggregate liability for all claims arising out of the AI Agent’s autonomous actions (including "Hallucination-led Breach") shall not exceed the **total fees paid by the Customer in the 6 months** preceding the event.
...
3. **Probabilistic Variance:** If the output is factually possible but not what the customer expected, can the Provider demonstrate that the AI’s reasoning path was "Logically Coherent" based on the prompt? (If yes  **Plausible View**).
...
> 3. **Finality:** The Expert’s technical finding shall be **binding** for the purpose of calculating Service Credits, but may be challenged in Arbitration only on the grounds of manifest bias or fraud."
> 
> 
...
* **Human-in-the-Loop (HITL):** Mandatory approval gates for actions exceeding ₹[Amount] or involving sensitive data categories.
...
> 
> 
> 🚨 **MANDATORY DISCLOSURE (Synthetically Generated Information)**
...
2. **The LinkedIn AI Label:** LinkedIn’s 2026 interface now includes a toggle: **"Is this AI-generated?"** You must switch this **ON**. Failure to do so can result in "Shadow-banning" or account suspension under MeitY's proactive detection mandate.
...
### **The 2026 Legal Blogger’s AI Compliance Checklist**
